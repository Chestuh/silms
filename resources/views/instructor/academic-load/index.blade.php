...
<p class="text-muted small mb-3">Validate subject loads for irregular or transferee students in your classes to avoid overload or conflicts.</p>

<form method="GET" action="{{ route('instructor.academic-load.index') }}" class="row g-2 mb-4">
    <div class="col-auto">
...
<div class="alert alert-warning">The following students have enrolled units exceeding {{ $maxUnits }} units.</div>
